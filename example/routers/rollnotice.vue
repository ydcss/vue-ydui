<template>
    <yd-layout title="RollNotice">
        ...
        <div class="demo-small-pitch">
            ...
            <yd-rollnotice align="center" height="50" autoplay="2500" class="demo-small-pitch">
                <yd-rollnotice-item>
                    设置高度！设置高度！<br/>
                    内容居中！内容居中！<br/>
                </yd-rollnotice-item>
            ...
            <yd-rollnotice direction="down" align="right" height="50" autoplay="2500" class="demo-small-pitch">
                <yd-rollnotice-item>
                    向下滚动！向下滚动！<br/>
                    向下滚动！向下滚动！<br/>
                </yd-rollnotice-item>
